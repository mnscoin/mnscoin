...
RESOURCES += src/qt/mnscoin.qrc src/qt/mnscoin_locale.qrc

TRANSLATIONS += src/qt/locale/mnscoin_bg.ts \
                src/qt/locale/mnscoin_de.ts \
                src/qt/locale/mnscoin_en.ts \
                src/qt/locale/mnscoin_es.ts \
                src/qt/locale/mnscoin_fi.ts \
                src/qt/locale/mnscoin_fr.ts \
                src/qt/locale/mnscoin_it.ts \
                src/qt/locale/mnscoin_ja.ts \
                src/qt/locale/mnscoin_pl.ts \
                src/qt/locale/mnscoin_pt.ts \
                src/qt/locale/mnscoin_ru.ts \
                src/qt/locale/mnscoin_sk.ts \
                src/qt/locale/mnscoin_sv.ts \
                src/qt/locale/mnscoin_vi.ts \
                src/qt/locale/mnscoin_zh_CN.ts \
                src/qt/locale/mnscoin_zh_TW.ts
