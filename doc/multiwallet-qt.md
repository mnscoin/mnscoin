...
In order to support loading of multiple wallets in mnscoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mnscoin.cpp.
...
Changes to mnscoin.cpp
----------------------
mnscoin.cpp is the entry point into mnscoin-qt, and as such, will require some minor modifications to provide hooks for
