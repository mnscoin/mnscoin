...
This mechanism has been integrated into Bitcore-Node-MNS which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/MNS-Project/insight-api-mnscoin#web-socket-api](https://github.com/MNS-Project/insight-api-mnscoin#web-socket-api) 
* API: [https://github.com/MNS-Project/insight-api-mnscoin#swifttx-transactions](https://github.com/MNS-Project/insight-api-mnscoin#swifttx-transactions) 
...
By default, the Mnscoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Mnscoin Core daemon:
