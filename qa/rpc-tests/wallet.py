...
#   c) node1 mines 32 blocks, so now node 0 has 60001mnscoin, node 1 has 4250mnscoin, node2 has none.
#   d) node0 sends 601 mnscoin to node2, in two transactions (301 mnscoin, then 300 mnscoin).
