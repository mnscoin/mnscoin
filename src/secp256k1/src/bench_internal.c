...
void bench_group_mnscoinobi_var(void* arg) {
    int i;
    bench_inv *data = (bench_inv*)arg;
...
#ifndef USE_NUM_NONE
void bench_num_mnscoinobi(void* arg) {
    int i;
    bench_inv *data = (bench_inv*)arg;
    ...
    for (i = 0; i < 200000; i++) {
        secp256k1_num_mnscoinobi(&nx, &norder);
    }
}
#endif
...
int main(int argc, char **argv) {
    ...
    if (have_flag(argc, argv, "group") || have_flag(argc, argv, "mnscoinobi")) run_benchmark("group_mnscoinobi_var", bench_group_mnscoinobi_var, bench_setup, NULL, &data, 10, 20000);
...
#ifndef USE_NUM_NONE
    if (have_flag(argc, argv, "num") || have_flag(argc, argv, "mnscoinobi")) run_benchmark("num_mnscoinobi", bench_num_mnscoinobi, bench_setup, NULL, &data, 10, 200000);
#endif
    return 0;
}
