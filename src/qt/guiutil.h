...
/** Utility functions used by the MNS Qt UI.
 */
namespace GUIUtil
{
...
// Render MNS addresses in monospace font
...
// Parse "mnscoin:" URI into recipient object, return true on successful parsing
