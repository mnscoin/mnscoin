...
/* Mnscoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "MNS"
#define QAPP_ORG_DOMAIN "mnscoin.org"
#define QAPP_APP_NAME_DEFAULT "MnsCoin-Core"
#define QAPP_APP_NAME_TESTNET "MnsCoin-Core-testnet"
