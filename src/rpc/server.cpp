...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MNS features */
        {"mnscoin", "masternode", &masternode, true, true, false},
        {"mnscoin", "listmasternodes", &listmasternodes, true, true, false},
        {"mnscoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mnscoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mnscoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"mnscoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"mnscoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"mnscoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mnscoin", "masternodedebug", &masternodedebug, true, true, false},
        {"mnscoin", "startmasternode", &startmasternode, true, true, false},
        {"mnscoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mnscoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mnscoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mnscoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mnscoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mnscoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mnscoin", "mnsync", &mnsync, true, true, false},
        {"mnscoin", "spork", &spork, true, true, false},
        {"mnscoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> mnscoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:24571/\n";
}
