...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1592833852, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("047be626d85831f24a14157892106cd967ad211f1375512d77dc67e47a9f5d319730922e521bc2279187df35a7b7adcf2140228d1c51c7deb6291f361376591196");
        nDefaultPort = 24572;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // MNS starting difficulty is 1 / 2^12
        nMaxReorganizationDepth = 100;
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // MNS: 1 day
        nTargetSpacing = 1 * 60;  // MNS: 1 minute
        nMaturity = 80;
        ...
        nEnforceNewSporkKey = 1592833852;
        nRejectOldSporkKey = 1592833852;

        const char* pszTimestamp = "Join to crypto revolution";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1592833852;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 471733;

        hashGenesisBlock = genesis.GetHash();


        assert(hashGenesisBlock == uint256("0x000001efabad6756e1937bc1c1b98bd066b29fb4e65e750d2ff3e2ca0f7d13d2"));
        assert(genesis.hashMerkleRoot == uint256("0xa7d76d50fc3b7998b62d003f33adaa06242850e4b32b62b17691d5a4222a9145"));
        ...
        strSporkKey = "04eb6ca9d878c19e2e6553b4b98acdbd9f47f454459a7e048effc6a859a2048ca6d910c817ddd7d81b4daaf9ce9af4407f6a3b2af0999d1423961bb3ef525390ec";
        strSporkKeyOld = "04ed2b3d956c32a13ee185ed4e00646526770a58188ffeb308d8992c3e1c50c019aff991b49f385175973c2120561f4500f8e814d061eee163717dc6b477dafb71";
        strObfuscationPoolDummyAddress = "MGfbXEa8iaB4M5GJs3Kq4ZdQ6V97BW6hyw";
        nStartMasternodePayments = 1592833852;
    }
...
public:
    CRegTestParams()
    {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // MNS: 1 day
        nTargetSpacing = 1 * 60;        // MNS: 1 minutes
