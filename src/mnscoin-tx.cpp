...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Mnscoin Core mnscoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mnscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mnscoin transaction") + "\n" +
                               "  mnscoin-tx [options] -create [commands]   " + _("Create hex-encoded mnscoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mnscoin transaction
