/* src/config/mnscoin-config.h.  Generated from mnscoin-config.h.in by configure.  */
/* src/config/mnscoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "mnscoin.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Mnscoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Mnscoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "mnscoin"
