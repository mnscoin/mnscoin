Contributing to Mnscoin Core
============================

The Mnscoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Mnscoin Core project, and is not to be
confused with overall MNS Network Protocol consensus changes.

Whether a pull request is merged into Mnscoin Core rests with the project merge
...
Patches that change MNS consensus rules are considerably more involved than
...
Where a patch set proposes to change the MNS consensus, it must have been
...
The project leader is the release manager for each Mnscoin Core release.
